...
def steps_main(step: int):
    global steps_window,steps_levels, zona_label, dce_check, catT2,catDWI, eep, info, mapa_flag, psa_value, fpsa_value, psa_date1, psa_date2, psa_date3, t1,t2,t3,t4,t5,t6,hemo,neuro,vesi,huesos,organos,linfa,uretra, auxframe2, zona, lesion_flag, institu
    mapa_flag = False
