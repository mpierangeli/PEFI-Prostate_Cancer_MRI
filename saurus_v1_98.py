...
def steps_main(step: int):
    ...
    if step == 1:
        ...
        psa_value = Entry(auxframe1,width=4,font=("Roboto",12),fg="#FFF",bd=0,bg="#666",insertbackground="#2CC")
        psa_value.pack(side=LEFT)
        Label(auxframe1, text="f PSA:",bg="#555",font=("Roboto",10),fg="#FFF",width=7).pack(side=LEFT)
        fpsa_value = Entry(auxframe1,width=4,font=("Roboto",12),fg="#FFF",bd=0,bg="#666",insertbackground="#2CC")
        ...
        Label(auxframe1, text="/",bg="#555",font=("Roboto",10),fg="#FFF",width=1).pack(side=LEFT)
        psa_date3= Entry(auxframe1,width=4,font=("Roboto",12),fg="#FFF",bd=0,bg="#666",insertbackground="#2CC")
        ...
        try: prosta.psa = [psa_value.get(),fpsa_value.get(),psa_date1.get(),psa_date2.get(),psa_date3.get()]
        except: pass
            ...
            if  temp_uid not in sec_uids:
                try: 
                    if temp_dcm.ContrastBolusAgent:
                        dce_secs.append(secuencia(temp_dcm.SequenceName+"-> TE: "+str(temp_dcm.EchoTime)+", TR: "+str(temp_dcm.RepetitionTime)+", "+str(temp_dcm.ScanOptions)+", UID: "+temp_uid[-4:-1]))
                except:
